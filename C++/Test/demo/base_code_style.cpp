...
int main()
{
	...
	// 类，结构体，类型定义，别名，枚举，采用每个单词首字母均大写并且不包含下划线
	// 普通变量命名，函数参数，数据成员一律采用小写，单词之间下划线连接
	// 函数命名采用大小写混合，取值和设值函数则要求与变量名匹配,如：MyExcitingFunction()
	int price_count_reader;  // 行尾注释要求 分号后面空两行，再一个空格后开始写注释
	return 0;
}
...
// 作者：MickelZhang
// 日期：2020/12/12
// 修改人：MickelZhang 2020/12/12/20:00
// 记录：
// 修改人：
// 记录：
// 版本：
